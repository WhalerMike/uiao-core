...
4.  **Certificate-anchored overlay** — Security documents grouped
    consistently
5.  **Telemetry as control** — Telemetry documents grouped under
    compliance
6.  **Embedded governance and automation** — Structure supports
    automation
