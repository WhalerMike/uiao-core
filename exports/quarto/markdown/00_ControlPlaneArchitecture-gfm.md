...
- [<span class="toc-section-number">1</span> Unified
  ...
  - [<span class="toc-section-number">1.1</span> Control Plane
  ...
  - [<span class="toc-section-number">1.6</span> 6. Architecture
    ...
    - [<span class="toc-section-number">1.6.2</span> 6.2 Plane
      Definitions](#62-plane-definitions)
  ...
  - [<span class="toc-section-number">1.9</span> 9. Dependencies &
    ...
    - [<span class="toc-section-number">1.9.1</span>
      Upstream](#upstream)
    - [<span class="toc-section-number">1.9.2</span>
...
This document defines the six control planes that form the foundation of
the Unified Identity-Addressing-Overlay (UIAO) architecture. It
establishes the authoritative structure, responsibilities, boundaries,
and interactions of each plane, ensuring deterministic behavior across
identity, network, addressing, telemetry, security, and management
domains.
...
This document defines all six UIAO control planes and establishes their
relationships.
...
These concepts are frozen and must appear identically across all UIAO
documents.
...
The UIAO architecture replaces legacy perimeter-centric models with a
federated, identity-driven, telemetry-informed control plane system.
Each plane is authoritative for a specific domain but interoperates
through deterministic, identity-anchored relationships.
...
- **Authoritative Systems:** M365 Network Telemetry, SD-WAN telemetry,
  Defender/Intune, DNS telemetry
- **Responsibilities:**
...
- **Outputs:** Assurance signals, routing modifiers, compliance
  indicators
...
system must produce the same decision across clouds, agencies, and
implementations.
